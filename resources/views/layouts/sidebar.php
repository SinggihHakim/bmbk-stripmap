    ...
    [
        ...
        'items' => [
            [
                ...
                'sub'   => [
                    ['label' => 'Ringkasan Dashboard', 'url' => '', 'match' => ['']],
                    ['label' => 'Detail Rusak Ringan',  'url' => 'dashboard/detail?kondisi=rusak_ringan', 'match' => ['dashboard/detail?kondisi=rusak_ringan']],
                    ['label' => 'Detail Rusak Berat',   'url' => 'dashboard/detail?kondisi=rusak_berat',  'match' => ['dashboard/detail?kondisi=rusak_berat']],
                ]
            ],
        ]
    ],
